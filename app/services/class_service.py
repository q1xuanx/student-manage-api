...
async def search_student_by_class(conn : Connection, class_search : str) -> Dict[str, Any]:
    ...
    for item in classes:
        ...
        list_class.setdefault(item['classname'], {}).setdefault('students', []).append(student)
